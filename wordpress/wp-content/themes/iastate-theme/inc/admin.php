...
$options = array(
	...
	array(
		"name"     => "Navigation Bar Setup",
		"type"     => "sub-section-3",
		"category" => "nav-setup",
	),
	array(
		"name"    => "Pages to show in Navigation Bar",
	...
	array(
		"name"   => "Custom Google Analytics Tracking Code",
	...
	array(
		"name"    => "category posts to show on the front page",
	...
	array(
		"name"    => "category posts to show on the front page below",
		"desc"    => "Select the category you want to include. All pages are excluded by default",
